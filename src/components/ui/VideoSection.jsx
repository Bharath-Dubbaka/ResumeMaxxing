...
const VideoSection = () => {
   return (
      <section className="flex flex-col md:flex-row items-center justify-between px-16 py-28 rounded-lg backdrop-blur-md bg-gradient-to-br from-blue-100/70 via-teal-50/95 to-yellow-50/95 animate-gradient-xy">
         {/* Video Embed */}
