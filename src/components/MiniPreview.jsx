        ...
        <div className="p-8 space-y-6 text-[11px] leading-relaxed">
          ...
          <div>
            ...
            {userDetails?.customSkills?.length > 0 ? (
              ...
              <p className="text-gray-600 italic">
                List of your skills as per provided job description and custom
                saved. Ex: Java, Spring, React.js, Node.js
              </p>
            )}
          </div>
          ...
          <div>
            ...
            {userDetails?.experience?.length > 0 ? (
                  ...
                  <div key={index}>
                    ...
                    <div>
                      <ul className="list-disc pl-4 text-[10px]">
                        ...
                        {Array.isArray(exp?.customResponsibilities) ? (
                          exp.customResponsibilities.map((item, idx) =>
                            typeof item === "string" && item.trim() ? (
                              <li key={idx}>{item}</li>
                            ) : null,
                          )
                        ) : typeof exp?.customResponsibilities === "string" &&
                          exp.customResponsibilities.trim() ? (
                          <li>{exp.customResponsibilities.trim()}</li>
                        ) : null}
                        <li>Responsibilities generated based on Job/skills</li>
                        <li>
              ...
              <div className="text-gray-600 italic">
                ...
                <div className="font-semibold mt-0">Company Name, Location</div>
                <ul className="list-disc pl-4">
                  <li>
                    {" "}
                    New Responsibilities will be generated based on Job/skills
                  </li>
                  <li>
                    {" "}
                    New Responsibilities will be generated based on Job/skills
