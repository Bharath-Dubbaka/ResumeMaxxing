...
export default function HybridPreview({
  ...
  return (
    <div className="bg-white text-black px-4 py-8 md:px-8 md:py-8 rounded-lg max-h-[600px] overflow-y-auto font-['Cambria']">
      <div className="space-y-6">
        {/* Header Section*/}
        <div className="text-['Arial'] text-left space-y-2">
          ...
          <p className="text-gray-600 font-['Arial'] underline">
            {isEditing ? (
              <input
                type="text"
        ...
        <div>
          <h2 className="text-xl font-bold text-['Arial'] border-b-2 mb-2">
            Professional Summary
          </h2>
          {isEditing ? (
            <textarea
            ...
            <p className="text-sm">
              ...
              <span className="bg-green-100 rounded px-1">
                {resumeData.summaryParts.appended}
              </span>{" "}
              <span className="text-xs bg-emerald-600 text-white px-2 py-1 rounded align-middle">
                New
              </span>
            </p>
          ) : (
          ...
          {resumeData.professionalExperience.map((exp, expIndex) => (
            <div key={expIndex} className="mb-4">
              <div className="flex justify-between items-start">
                <div>
                  {isEditing ? (
                    <div className="space-y-2 text-['Arial'] ">
                      <input
                        type="text"
                        value={exp.title || ""}
                        onChange={(e) =>
                ...
                {isEditing ? (
                  <div className="space-x-2 text-['Arial'] ">
                    <input
                      type="text"
                      value={exp.startDate || ""}
                      onChange={(e) =>
                  ...
                  <p className="text-sm text-gray-600 text-['Arial'] ">
                          ...
                          <div className="flex items-start justify-between w-full gap-2">
                            ...
                            {!savedResponsibilities[`${expIndex}-${resp}`] && (
                              <div className="flex items-center gap-1 flex-shrink-0">
                                {/* <span className="opacity-50 group-hover:opacity-100 text-xs bg-emerald-600 text-white px-2 py-1 rounded transition-all">
                                  New
                                </span> */}
                                <button
                                  onClick={() =>
        ...
        {resumeData.education && resumeData.education.length > 0 && (
          <div className="mt-6">
            <h2 className="text-xl text-['Arial'] font-bold mb-4 border-b-2 ">
              Education
            </h2>
